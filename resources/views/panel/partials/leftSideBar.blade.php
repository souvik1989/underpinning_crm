        ...
        <div class="iconsidebar-menu">
          <div class="sidebar">
            <ul class="iconMenu-bar custom-scrollbar">
              ...
              <li class="{{ (str_starts_with(Route::current()->getName(), 'user.') || str_starts_with(Route::current()->getName(), 'user2.') || str_starts_with(Route::current()->getName(), 'user-all.')) ? 'open2' : '' }}"><span class="badge badge-pill badge-danger">{{$user_count ?? 0}}</span><a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-users"></i><span>Leads</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Best Underpinning</li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'user.') ? 'active' : '' }}"><a href="{{route('user.index')}}" class="{{ str_starts_with(Route::current()->getName(), 'user.') ? 'active' : '' }}">Leads</a></li>
                  
                  <li class="iconbar-header">Sydney Underpinning </li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'user2.') ? 'active' : '' }}"><a href="{{route('user2.index')}}" class="{{ substr(Route::current()->getName(),0,6)=='user2.' ? 'active' : '' }}">Leads</a></li>
                 <li class="iconbar-header">All Leads </li>
                 <li class="{{ str_starts_with(Route::current()->getName(), 'user-all.') ? 'active' : '' }}"><a href="{{route('user-all.index')}}"  class="{{ substr(Route::current()->getName(),0,9)=='user-all.' ? 'active' : '' }}">Leads</a></li>
                </ul>
              </li>

                <li class="{{ (str_starts_with(Route::current()->getName(), 'job.') || str_starts_with(Route::current()->getName(), 'future-job.') ) ? 'open2' : '' }}"><a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-id"></i><span>Jobs</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Current Jobs</li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'job.') ? 'active' : '' }}"><a href="{{route('job.index')}}" class="{{ str_starts_with(Route::current()->getName(), 'job.') ? 'active' : '' }}">Job lists</a></li>
                  
                  <li class="iconbar-header">Future Jobs</li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'future-job.') ? 'active' : '' }}"><a href="{{route('future-job.index')}}" class="{{ str_starts_with(Route::current()->getName(), 'future-job.') ? 'active' : '' }}">Job lists</a></li>
                  
                </ul>
              </li>
              
                <li class="{{ (str_starts_with(Route::current()->getName(), 'quote.')  ) ? 'open2' : '' }}"><a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-note2"></i><span>Quotes</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">All Quotes</li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'quote.') ? 'active' : '' }}"><a href="{{route('quote.index')}}" class="{{ str_starts_with(Route::current()->getName(), 'quote.') ? 'active' : '' }}">Quote lists</a></li>
                  
                  
                  
                </ul>
              </li>
              <li class="{{ (str_starts_with(Route::current()->getName(), 'invoice.')  ) ? 'open2' : '' }}"><a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-news-paper"></i><span>Invoices</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">All Invoices</li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'invoice.') ? 'active' : '' }}"><a href="{{route('invoice.index')}}" class="{{ str_starts_with(Route::current()->getName(), 'invoice.') ? 'active' : '' }}">Invoice lists</a></li>
                  
                  
                  
                </ul>
              </li>
                <li class="{{ (str_starts_with(Route::current()->getName(), 'supplier.')  ) ? 'open2' : '' }}"><a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-server"></i><span>Suppliers</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">All Suppliers</li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'supplier.') ? 'active' : '' }}"><a href="{{route('supplier.index')}}" class="{{ str_starts_with(Route::current()->getName(), 'supplier.') ? 'active' : '' }}">Supplier lists</a></li>
               ...
               <li class="{{ (str_starts_with(Route::current()->getName(), 'email.')  ) ? 'open2' : '' }}"><a class="bar-icons" href="javascript:void(0)"><i class="pe-7s-mail-open-file"></i><span>Email</span></a>
                <ul class="iconbar-mainmenu custom-scrollbar">
                  <li class="iconbar-header">Email</li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'email.list') ? 'active' : '' }}"><a href="{{route('email.list')}}" class="{{ str_starts_with(Route::current()->getName(), 'email.list') ? 'active' : '' }}"> Email List</a></li>
                  <li class="{{ str_starts_with(Route::current()->getName(), 'email.show') ? 'active' : '' }}"><a href="{{route('email.show')}}" class="{{ str_starts_with(Route::current()->getName(), 'email.show') ? 'active' : '' }}">Send Email</a></li>
