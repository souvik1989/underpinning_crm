        ...
        <div class="page-header">
            <div class="row">
                <div class="col-lg-6 main-header">
                    ...
                    <h6 class="mb-0">Best Underpinning</h6>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                          <a href="{{ route('user.job',$user->id) }}" class="btn btn-pill btn-info edit-sec" title="Add Job">
                          <i class="pe-7s-plus"></i>
                        </a>
                                        </td>
                                        
                                         <td>
                                          <a href="{{ route('user.quote',$user->id) }}" class="btn btn-pill btn-danger edit-sec" title="Add Quote">
                          <i class="pe-7s-plus"></i>
                        </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="{{ route('user.edit', $user) }}" class="btn btn-pill btn-warning edit-sec" title="Edit">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('user.reply')}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="email" name="recipient" value="{{$user->email}}" class="form-control @error('recipient') is-invalid @enderror" id="recipient" placeholder="Enter Recipient">
