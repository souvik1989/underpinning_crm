            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('user-all.create') }}" class="btn btn-primary mb-3">
                            + Add new Lead
                        </a>
                            ...
                            <table class="display" id="advance-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown action-label">
                                                ...
                                                <div class="dropdown-menu">
                                                    <form action="{{route('user-all.status', $user->id)}}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                        ...
                                        <td>
                                            <a href="{{ route('user-all.edit', $user) }}" class="btn btn-pill btn-warning edit-sec" title="Edit">
                                                <i class="pe-7s-edit"></i>
                                            </a>
                                            <div class="d-inline-block">
                                                <form action="{{route('user-all.destroy', $user->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
