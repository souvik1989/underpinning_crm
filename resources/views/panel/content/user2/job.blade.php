...
<div class="page-body">
    ...
    <div class="input-group input-group-merge">
        ...
        <input type="date" name="job_date" class="form-control @error('job_date') is-invalid @enderror" id="job_date" placeholder="Job Date" value="{{old('job_date')}}" />
    </div>
</div>
...
<div class="mb-3 col-lg-4 col-md-6">
   <label class="form-label" for="Address">No. of Hours</label>
    <div class="input-group input-group-merge">
        ...
        <input type="number" min="0" name="hours" class="form-control @error('hours') is-invalid @enderror" id="hours" placeholder="No of Hours" value="{{old('hours')}}" />
    </div>
</div>
