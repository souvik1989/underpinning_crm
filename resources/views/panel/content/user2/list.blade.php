                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                          ...
                                          <td>
                                          <a href="{{ route('user2.job',$user->id) }}" class="btn btn-pill btn-info edit-sec" title="Add Job">
                          <i class="pe-7s-plus"></i>
                        </a>
                                        </td>
                                        
                                         <td>
                                          <a href="{{ route('user2.quote',$user->id) }}" class="btn btn-pill btn-danger edit-sec" title="Add Quote">
                          <i class="pe-7s-plus"></i>
                        </a>
                                        </td>
                                        <td>
