 ...
 <div class="page-body">
          ...
          <div class="container-fluid general-widget">
                  ...
                  <div class="b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0 text-white">INVOICES</span>
                        <h4 class="mb-0 counter">{{$invoice_count}}</h4><i class="icon-bg" data-feather="file-text"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">QUOTES</span>
                        <h4 class="mb-0 counter">{{$quote_count}}</h4><i class="icon-bg" data-feather="printer"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0 text-white">JOBS</span>
                        <h4 class="mb-0 counter text-white">{{$job_count}}</h4><i class="icon-bg" data-feather="briefcase"></i>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="csv-button">
                <a href="{{ route('users.export') }}" class="btn btn-primary">Export Leads </a>
            </div>
            <div class="row">
                        ...
                        @foreach($invoices as $inv)
                          <tr>
                            ...
                            <td>
                              ...
                              @else
                                <div class="span badge badge-pill pill-badge-danger">{{$inv->status ?? ''}}</div>
                                @endif
                            </td>
