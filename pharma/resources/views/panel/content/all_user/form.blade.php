...
<div class="mb-3">
    ...
    <div class="input-group input-group-merge">
        ...
        <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" id="FirstName" placeholder="First Name" value="{{old('first_name', isset($user->first_name) ? $user->first_name:'')}}" />
    </div>
</div>
...
<a class="btn btn-danger" href="{{ route('user-all.index') }}">Cancel</a>
