...
<div class="row">
    ...
    <div class="input-group input-group-merge">
        ...
        <input type="date" name="quote_date" class="form-control @error('quote_date') is-invalid @enderror" id="quote_date" placeholder="Quote Date"  />
    </div>
</div>
...
<div class="mb-3 col-lg-4 col-md-6">
    ...
    <div class="input-group input-group-merge">
        ...
        <input type="number" min="0" name="quantity" class="form-control @error('quantity') is-invalid @enderror" id="quantity" placeholder="Quantity"  />
    </div>
</div>
