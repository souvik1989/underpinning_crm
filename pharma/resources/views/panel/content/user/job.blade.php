...
<div class="page-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('user.job.post',$user)}}" class="needs-validation" novalidate="" method="POST" autocomplete="off" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="input-group input-group-merge">
        ...
        <input type="date" name="job_date" class="form-control @error('job_date') is-invalid @enderror" id="job_date" placeholder="Job Date" value="" />
    </div>
</div>
...
<div class="mb-3 col-lg-4 col-md-6">
   <label class="form-label" for="Address">No. of Hours</label>
    <div class="input-group input-group-merge">
        ...
        <input type="number" min="0" name="hours" class="form-control @error('hours') is-invalid @enderror" id="hours" placeholder="No of Hours" value="" />
    </div>
</div>
...
<div class="mb-3 col-lg-4 col-md-6">
    ...
    <div class="input-group input-group-merge">
        ...
        <input type="number" min="0" name="quantity" class="form-control @error('quantity') is-invalid @enderror" id="quantity" placeholder="Quantity" value="" />
    </div>
</div>
...
<div class="mb-3 col-lg-4 col-md-6">
    ...
    <div class="input-group input-group-merge">
        ...
        <input type="text" name="price" class="form-control @error('price') is-invalid @enderror" id="price" placeholder="Price" value="" />
    </div>
...
<div class="mb-3 col-lg-4 col-md-6">
    ...
    <div class="input-group input-group-merge">
    <span>* Price will include GST @ 10%</span></div>
...
<div class="mb-3 col-lg-12 col-md-12">
    ...
    <div class="input-group input-group-merge">
        ...
        <textarea class="form-control @error('address') is-invalid @enderror" rows="4" name="address" id="Address"></textarea>
    </div>
</div>
...
<div class="mb-3 col-lg-12 col-md-12">
    ...
    <div class="input-group input-group-merge">
        ...
        <textarea class="form-control @error('site_address') is-invalid @enderror" rows="4" name="site_address" id="site_address"></textarea>
    </div>
</div>
<div class="mb-3 col-lg-12 col-md-12">
...
<div class="mb-3 col-lg-12 col-md-12">
    ...
    <div class="input-group input-group-merge">
        ...
        <textarea class="form-control @error('comment') is-invalid @enderror" rows="4" name="comment" id="comment"></textarea>
    </div>
</div>
</div>
