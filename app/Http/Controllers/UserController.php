    ...
    public function exportUsersToCSV()
{
    ...
    $columns = array('Name', 'Email','Phone','Business Name','Site URL','Message', 'Created At');
    ...
    $callback = function() use ($users, $columns) {
        ...
        foreach ($users as $user) {
            ...
            $row['Business_Name'] = $user->business_name;
             $row['Site_URL'] = $user->site_url;
              $row['Message'] = $user->message;
            $row['Created At'] = \Carbon\Carbon::parse($user->created_at)->format('d/m/Y');

            fputcsv($file, array($row['Name'], $row['Email'],$row['Phone'], $row['Business_Name'],$row['Site_URL'] , $row['Message'] , $row['Created At']));
        }
